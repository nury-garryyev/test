...
public class DefaultDavidoffcoreService implements DavidoffcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDavidoffcoreService.class);
	...
	{
		return DefaultDavidoffcoreService.class.getResourceAsStream("/davidoffcore/sap-hybris-platform.png");
	}
